...
public class InitialConfiguration {
    ...
    CommandLineRunner commandLineRunner(
        ...
        return args -> {
            ...
            DailyCarbonatesIntake dci1= new DailyCarbonatesIntake(0,LocalDate.of(2023,2,15),LocalTime.of(10,22),200.0,pat2);
            DailyCarbonatesIntake dci2= new DailyCarbonatesIntake(0,LocalDate.of(2023,3,14),LocalTime.of(12,17),190.0,pat1);
