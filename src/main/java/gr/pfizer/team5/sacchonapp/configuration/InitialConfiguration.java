...
public class InitialConfiguration {
    ...
    CommandLineRunner commandLineRunner(
        ...
        return args -> {
            ...
            BloodGlucoseLevel bgl1 = new BloodGlucoseLevel(0, LocalDate.of(2022,10,10), LocalTime.of(12,16),12.0,pat1);
            BloodGlucoseLevel bgl2 = new BloodGlucoseLevel(0, LocalDate.of(2022,11,13), LocalTime.of(13,20),10.0,pat2);
            BGLRepository.saveAll(List.of(bgl1, bgl2));
            DailyCarbonatesIntake dci1= new DailyCarbonatesIntake(0,LocalDate.of(2022,12,5),LocalTime.of(10,22),200.0,pat1);
            ...
            Doctor doc1 = new Doctor(0,"appdoc@cod.gr","werqr2","Panagiota","Deli", List.of(pat1,pat2));
            ...
            Consultation cons2 = new Consultation(0, LocalDate.of(2023,1,18),"lyrica",10,"one per day",2,pat2);
